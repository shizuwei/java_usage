...
public class HanZiPinYin {
    ...
    private static HanZiPinYin chineseSpelling = new HanZiPinYin();

    public static HanZiPinYin getInstance() {
    ...
    public static String trans2PinYin(String str) {
        return HanZiPinYin.getInstance().convertAll(str);
    }
